...
const navigation = [
  ...
  { name: "Inventory", href: "/dashboard/inventory", icon: Warehouse, roles: ["PRODUCTION_LOGISTICS", "MANAGEMENT_ADMIN"] },
  ...
  { name: "Live tracking", href: "/dashboard/field/tracking", icon: MapPinned, roles: ["MANAGEMENT_ADMIN"] },
